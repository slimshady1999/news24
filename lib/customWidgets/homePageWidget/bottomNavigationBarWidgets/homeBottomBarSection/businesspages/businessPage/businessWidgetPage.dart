...
// ignore: non_constant_identifier_names
class BusinessTrendsSectionWidget extends StatefulWidget {
  const BusinessTrendsSectionWidget({Key? key}) : super(key: key);

  @override
  State<BusinessTrendsSectionWidget> createState() =>
      _BusinessTrendsSectionWidgetState();
}

class _BusinessTrendsSectionWidgetState
    extends State<BusinessTrendsSectionWidget> {
