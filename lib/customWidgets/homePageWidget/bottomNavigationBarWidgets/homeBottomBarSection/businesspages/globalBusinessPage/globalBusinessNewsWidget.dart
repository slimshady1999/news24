...
class GlobalBusinessWidget extends StatefulWidget {
  const GlobalBusinessWidget({Key? key}) : super(key: key);

  @override
  State<GlobalBusinessWidget> createState() => _GlobalBusinessWidgetState();
}

class _GlobalBusinessWidgetState extends State<GlobalBusinessWidget> {
