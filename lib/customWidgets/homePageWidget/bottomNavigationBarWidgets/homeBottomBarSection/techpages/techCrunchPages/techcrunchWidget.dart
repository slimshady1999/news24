...
class TechCrunchNewsWidget extends StatefulWidget {
  const TechCrunchNewsWidget({Key? key}) : super(key: key);

  @override
  State<TechCrunchNewsWidget> createState() => _TechCrunchNewsWidgetState();
}

class _TechCrunchNewsWidgetState extends State<TechCrunchNewsWidget> {
