...
import '../../../../../views/bitcoinpages/bitcoindetailspage.dart';

class CryptoTrendSection extends StatefulWidget {
  const CryptoTrendSection({Key? key}) : super(key: key);

  @override
  State<CryptoTrendSection> createState() => _CryptoTrendSectionState();
}

class _CryptoTrendSectionState extends State<CryptoTrendSection> {
